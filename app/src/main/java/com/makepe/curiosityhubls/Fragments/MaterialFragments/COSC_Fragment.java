...
public class COSC_Fragment extends Fragment {

    TabLayout COSC_Classes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        COSC_Classes = view.findViewById(R.id.LGCSE_classes);

        COSC_Classes.setVisibility(View.VISIBLE);

        formD_Recycler.setVisibility(View.VISIBLE);

        String activeSub = getArguments().getString("subject_name");

        String selectedClass = "Form D - COSC";
        ...
        COSC_Classes.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()){
                    case 0:
                        ...
                        break;
                    case 1:
                        String gradeSelected = "Form E - COSC";
